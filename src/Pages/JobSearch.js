          ...
          <h2 className='font-light text-3xl ml-2 mt-4'>Jobs</h2>
            ...
            <div className='h-full rounded-lg w-4/8 ml-2 mt-10 my-5 bg-white border-2 cursor-pointer hover:border-indigo-500 mr-3'>
              ...
              <div className='mt-5 flex justify-between items-center'>
                  ...
                  <h2 className='ml-4 mt-4 mr-4 text-3xl font-mono'>Flexible</h2>
                  <div className='flex'>
                    <MdOutlineInfo className='ml-4 mt-4 text-blue-500' /><p className='pt-2 px-1'>per hour</p>
                  </div>
                  </div>
                </div>
                <div className=' mt-7'> 
                  <h2 className='font-bold text-2xl ml-2'>DoorDash Dashers - Start Delivering Today</h2>
