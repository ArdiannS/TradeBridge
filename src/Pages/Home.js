  ...
  return (
    <>    <div className="w-full h-screen bg-zinc-200 flex flex-col justify-between">
      ...
      <div className="absolute bottom-[5%] md:min-w-[760px] mx-1 md:left-1/2 transform md:-translate-x-1/2 bg-white border border-slate-300 rounded-xl text-center shadow-xl z-10">
        ...
        <div className="flex justify-between flex-wrap px-8 py-6">
          <div className="flex items-center mb-4 hover:text-indigo-600">
          ...
          <div className="flex items-center mb-4 hover:text-indigo-600">
            <BookmarkIcon className="h-6 w-6 text-indigo-600 mr-2" />
            <p className="text-slate-700 font-medium hover:text-indigo-600">
              Candidate Rate
            </p>
          </div>
          <div className="flex items-center mb-4 hover:text-indigo-600">
            <ClipboardCheckIcon className="h-6 w-6 text-indigo-600 mr-2" />
            <p className="text-slate-700 font-medium hover:text-indigo-600">
